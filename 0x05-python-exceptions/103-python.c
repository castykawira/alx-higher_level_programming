 ...
 * @p: Pointer to the Python object (PyListObject) to be inspected
 */
void print_python_list(PyObject *p)
{
 ...
 * @p: Pointer to the Python object (PyBytesObject) to be inspected
 */
void print_python_bytes(PyObject *p)
{
	Py_ssize_t size, i;
 ...
 * @p: Pointer to the Python object (PyFloatObject) to be inspected
 */
void print_python_float(PyObject *p)
{
	char *buffer = NULL;
